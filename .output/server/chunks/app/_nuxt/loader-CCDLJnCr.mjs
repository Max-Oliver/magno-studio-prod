...
const _imports_0 = "" + publicAssetsURL("light/assets/imgs/logo-light.png");
const _sfc_main$3 = {};
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/common/Lines.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/common/ProgressScroll.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/common/cusor.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/common/loader.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { Lines as L, _sfc_main as _, _sfc_main$1 as a, _sfc_main$2 as b, _imports_0 as c };
//# sourceMappingURL=loader-CCDLJnCr.mjs.map
