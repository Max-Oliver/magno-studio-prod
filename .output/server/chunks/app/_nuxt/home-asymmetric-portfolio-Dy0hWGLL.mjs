...
const _imports_0 = "" + publicAssetsURL("light/assets/imgs/works/1/q1.jpg");
const _imports_1 = "" + publicAssetsURL("light/assets/imgs/works/1/q2.jpg");
const _imports_2 = "" + publicAssetsURL("light/assets/imgs/works/1/q3.jpg");
const _imports_3 = "" + publicAssetsURL("light/assets/imgs/works/1/q4.jpg");
const _imports_4 = "" + publicAssetsURL("light/assets/imgs/works/1/q5.jpg");
const _imports_5 = "" + publicAssetsURL("light/assets/imgs/works/1/q6.jpg");
const _imports_6 = "" + publicAssetsURL("light/assets/imgs/works/1/q7.jpg");
const _imports_7 = "" + publicAssetsURL("light/assets/imgs/works/1/q8.jpg");
const _imports_8 = "" + publicAssetsURL("light/assets/imgs/works/1/q9.jpg");
const _sfc_main$1 = {};
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/light/home-asymmetric-portfolio.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=home-asymmetric-portfolio-Dy0hWGLL.mjs.map
