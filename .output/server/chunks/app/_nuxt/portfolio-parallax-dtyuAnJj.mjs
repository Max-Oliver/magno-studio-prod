...
import { _ as _sfc_main$4 } from './Footer-BnFS96LL.mjs';
import '../server.mjs';
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dark/portfolio-parallax.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=portfolio-parallax-dtyuAnJj.mjs.map
