...
import { unref, useSSRContext, onUnmounted, ref, mergeProps, withCtx, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList } from 'vue';
import { ssrRenderComponent, ssrRenderAttr, ssrRenderClass, ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderStyle } from 'vue/server-renderer';
import { _ as _sfc_main$b, a as _sfc_main$1$1, b as _sfc_main$2$1, L as Lines, c as _imports_0$3 } from './loader-CbuutFIZ.mjs';
...
import { _ as _imports_0$4, a as _imports_1$2, b as _imports_2$1, c as _imports_3$1 } from './s4-Fkpan4SZ.mjs';
...
const _imports_0$2 = "" + publicAssetsURL("dark/assets/imgs/intro/freelancer-intro.jpg");
const _sfc_main$a = {};
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/home-freelancer/Contact.vue");
  return _sfc_setup$8 ? _sfc_setup$8(props, ctx) : void 0;
};
const Contact = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$4]]);
const _sfc_main$7 = {};
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "min-footer sub-bg pt-30 pb-30" }, _attrs))}><div class="container"><div class="row"><div class="col-lg-4 col-md-6 md-mb15"><div class="logo icon-img-100"><img${ssrRenderAttr("src", _imports_0$3)} alt=""></div></div><div class="col-lg-4 order-md-3"><div class="text-center"><p class="fz-14"> \xA9 2024 InFolio is Proudly Powered by <span class="underline main-color"><a href="https://themeforest.net/user/UiCamp" target="_blank"> UiCamp </a></span></p></div></div><div class="col-lg-4 col-md-6 order-md-2 md-mb15"><div class="links d-flex justify-content-end"><ul class="rest d-flex align-items-center"><li><a href="/dark/page-FAQS">FAQ</a></li><li class="ml-30"><a href="/dark/page-about3">Careers</a></li><li class="ml-30"><a href="/dark/page-contact3">Contact Us</a></li></ul></div></div></div></div></footer>`);
}
const _sfc_setup$7 = _sfc_main$7.setup;
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/home-freelancer/Footer.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const Footer = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$3]]);
const _imports_0 = "" + publicAssetsURL("dark/assets/imgs/intro/freelancer.png");
const _sfc_main$6 = {};
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/home-freelancer/Header.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/home-freelancer/Navbar.vue");
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Swiper2), mergeProps({ id: "content-carousel-container-unq-work" }, swiperOptions), {
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/home-freelancer/Portfolio.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    ...
    "data-scroll-index": "1"
  }, _attrs))}><div class="container"><div class="sec-head mb-80"><h6 class="sub-title main-color mb-25">Our Specialize</h6><div class="bord pt-25 bord-thin-top d-flex align-items-center"><h2>What We <span class="fw-200">Offer</span></h2><div class="ml-auto"><a href="/dark/page-services" class="go-more"><span class="text">View all services</span><span class="icon ti-arrow-top-right"></span></a></div></div></div><div class="row"><div class="col-lg-4"><div class="item-box radius-15 md-mb30"><div class="ti-paint-bucket main-color fz-50 mb-40"></div><h5 class="mb-15">UI / UX Design</h5><p> Live workshop where we define the main problems and challenges before building a strategic plan moving forward. </p><a href="/dark/page-services-details" class="rmore mt-30"><span class="sub-title">Read More</span><img${ssrRenderAttr("src", _imports_1$1)} alt="" class="icon-img-20 ml-5"></a></div></div><div class="col-lg-4"><div class="item-box radius-15 md-mb30"><div class="ti-layout-slider main-color fz-50 mb-40"></div><h5 class="mb-15">Web Development</h5><p> Live workshop where we define the main problems and challenges before building a strategic plan moving forward. </p><a href="/dark/page-services-details" class="rmore mt-30"><span class="sub-title">Read More</span><img${ssrRenderAttr("src", _imports_1$1)} alt="" class="icon-img-20 ml-5"></a></div></div><div class="col-lg-4"><div class="item-box radius-15"><div class="ti-rocket main-color fz-50 mb-40"></div><h5 class="mb-15">Digital Marketing</h5><p> Live workshop where we define the main problems and challenges before building a strategic plan moving forward. </p><a href="/dark/page-services-details" class="rmore mt-30"><span class="sub-title">Read More</span><img${ssrRenderAttr("src", _imports_1$1)} alt="" class="icon-img-20 ml-5"></a></div></div></div></div></section>`);
}
const _sfc_setup$3 = _sfc_main$3.setup;
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/home-freelancer/Services.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const Services = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1]]);
const _imports_3 = "" + publicAssetsURL("dark/assets/imgs/resume/s5.png");
const _imports_5 = "" + publicAssetsURL("dark/assets/imgs/resume/s6.png");
const _sfc_main$2 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "my-skills2" }, _attrs))}><div class="container"><div class="sec-head text-center mb-80"><h6 class="sub-title main-color mb-15">Our Portfolio</h6><h2>Our featured <span class="fw-200">projects</span></h2></div><div class="row md-marg"><div class="col-lg-2 col-md-4 col-6"><div class="item mb-30"><div class="box-bord main-bg"><div class="img"><img${ssrRenderAttr("src", _imports_0$4)} alt=""></div><span class="value">95%</span></div><h6 class="fz-18">UI / UX Design</h6></div></div><div class="col-lg-2 col-md-4 col-6"><div class="item mb-30"><div class="box-bord main-bg"><div class="img"><img${ssrRenderAttr("src", _imports_1$2)} alt=""></div><span class="value">90%</span></div><h6 class="fz-18">Development</h6></div></div><div class="col-lg-2 col-md-4 col-6"><div class="item mb-30"><div class="box-bord main-bg"><div class="img"><img${ssrRenderAttr("src", _imports_2$1)} alt=""></div><span class="value">85%</span></div><h6 class="fz-18">Graphic Design</h6></div></div><div class="col-lg-2 col-md-4 col-6"><div class="item mb-30"><div class="box-bord main-bg"><div class="img"><img${ssrRenderAttr("src", _imports_3)} alt=""></div><span class="value">84%</span></div><h6 class="fz-18">Sketch</h6></div></div><div class="col-lg-2 col-md-4 col-6"><div class="item mb-30"><div class="box-bord main-bg"><div class="img"><img${ssrRenderAttr("src", _imports_3$1)} alt=""></div><span class="value">78%</span></div><h6 class="fz-18">WordPress</h6></div></div><div class="col-lg-2 col-md-4 col-6"><div class="item mb-30"><div class="box-bord main-bg"><div class="img"><img${ssrRenderAttr("src", _imports_5)} alt=""></div><span class="value">85%</span></div><h6 class="fz-18">Graphic Design</h6></div></div></div></div></div>`);
}
const _sfc_setup$2 = _sfc_main$2.setup;
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/home-freelancer/Skills.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/home-freelancer/Testimonials.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/dark/home-freelancer.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=home-freelancer-DE107c8B.mjs.map
