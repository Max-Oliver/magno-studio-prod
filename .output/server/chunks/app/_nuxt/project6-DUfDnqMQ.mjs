...
import { _ as _sfc_main$5 } from './Next-fe2lfVpA.mjs';
...
const _imports_0 = "" + publicAssetsURL("light/assets/imgs/works/projects/4/1.jpg");
const _imports_1 = "" + publicAssetsURL("light/assets/imgs/works/projects/4/2.jpg");
const _imports_2 = "" + publicAssetsURL("light/assets/imgs/works/projects/4/3.jpg");
const _sfc_main$1 = {
  __name: "Works",
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/light/project6.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=project6-DUfDnqMQ.mjs.map
