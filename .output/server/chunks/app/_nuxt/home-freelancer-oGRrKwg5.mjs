...
import { d as data } from './works1-Bqs3lVE2.mjs';
import { S as Swiper2, a as SwiperSlide } from './swiper-slide-Dn_WuJYw.mjs';
import { N as Navigation } from './navigation-nPzHIgEI.mjs';
import { _ as _imports_0$4, a as _imports_1$2, b as _imports_2$1, c as _imports_3$1 } from './s4-DXuPQI_V.mjs';
...
const _imports_0$2 = "" + publicAssetsURL("light/assets/imgs/intro/freelancer-intro.jpg");
const _sfc_main$a = {};
...
_sfc_main$a.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/home-freelancer/About.vue");
  return _sfc_setup$a ? _sfc_setup$a(props, ctx) : void 0;
};
const About = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$6]]);
const _imports_0$1 = "" + publicAssetsURL("light/assets/imgs/blog/c4.jpg");
const _imports_1 = "" + publicAssetsURL("light/assets/imgs/blog/c5.jpg");
const _imports_2 = "" + publicAssetsURL("light/assets/imgs/blog/c6.jpg");
const _sfc_main$9 = {};
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/home-freelancer/Blog.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/home-freelancer/Contact.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/home-freelancer/Footer.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const Footer = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$3]]);
const _imports_0 = "" + publicAssetsURL("light/assets/imgs/intro/freelancer.png");
const _sfc_main$6 = {};
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/home-freelancer/Header.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/home-freelancer/Navbar.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/home-freelancer/Portfolio.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    ...
    "data-scroll-index": "1"
  }, _attrs))}><div class="container"><div class="sec-head mb-80"><h6 class="sub-title main-color mb-25">Our Specialize</h6><div class="bord pt-25 bord-thin-top d-flex align-items-center"><h2>What We <span class="fw-200">Offer</span></h2><div class="ml-auto"><a href="/light/page-services" class="go-more"><span class="text">View all services</span><span class="icon ti-arrow-top-right"></span></a></div></div></div><div class="row"><div class="col-lg-4"><div class="item-box radius-15 md-mb30"><div class="ti-paint-bucket main-color fz-50 mb-40"></div><h5 class="mb-15">UI / UX Design</h5><p> Live workshop where we define the main problems and challenges before building a strategic plan moving forward. </p><a href="/light/page-services-details" class="rmore mt-30"><span class="sub-title">Read More</span><img${ssrRenderAttr("src", _imports_1$1)} alt="" class="icon-img-20 ml-5"></a></div></div><div class="col-lg-4"><div class="item-box radius-15 md-mb30"><div class="ti-layout-slider main-color fz-50 mb-40"></div><h5 class="mb-15">Web Development</h5><p> Live workshop where we define the main problems and challenges before building a strategic plan moving forward. </p><a href="/light/page-services-details" class="rmore mt-30"><span class="sub-title">Read More</span><img${ssrRenderAttr("src", _imports_1$1)} alt="" class="icon-img-20 ml-5"></a></div></div><div class="col-lg-4"><div class="item-box radius-15"><div class="ti-rocket main-color fz-50 mb-40"></div><h5 class="mb-15">Digital Marketing</h5><p> Live workshop where we define the main problems and challenges before building a strategic plan moving forward. </p><a href="/light/page-services-details" class="rmore mt-30"><span class="sub-title">Read More</span><img${ssrRenderAttr("src", _imports_1$1)} alt="" class="icon-img-20 ml-5"></a></div></div></div></div></section>`);
}
const _sfc_setup$3 = _sfc_main$3.setup;
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/home-freelancer/Services.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const Services = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1]]);
const _imports_3 = "" + publicAssetsURL("light/assets/imgs/resume/s5.png");
const _imports_5 = "" + publicAssetsURL("light/assets/imgs/resume/s6.png");
const _sfc_main$2 = {};
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/home-freelancer/Skills.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/home-freelancer/Testimonials.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/light/home-freelancer.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=home-freelancer-oGRrKwg5.mjs.map
