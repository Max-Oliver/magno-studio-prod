...
import { C as Controller, E as EffectFade } from './effect-fade-CEYgk8Ge.mjs';
import '../server.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Swiper2), mergeProps(swiperOptionsImg, { onSwiper: setChildSwiper }), {
      ...
      _push(ssrRenderComponent(unref(Swiper2), mergeProps({ onInit: setMainSwiper }, swiperOptions, { class: "swiper-container swiper-container-initialized swiper-container-vertical" }), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(SwiperSlide), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/showcase-carousel/Header.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/light/showcase-carousel.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=showcase-carousel-DN21ruXo.mjs.map
