...
import { _ as _imports_0, a as _imports_2, b as _imports_3$1 } from './5-CbVp87jf.mjs';
import { _ as _imports_1, a as _imports_3, b as _imports_5 } from './6-Ci9DM-TK.mjs';
import { _ as _imports_4 } from './7-8Z6uVZSi.mjs';
import { _ as _imports_7 } from './8-B5bCqMZX.mjs';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({
        ...
        "data-overlay-dark": "9"
      }, _attrs))}><div class="container pt-100"><div class="text-center"><h1>Works</h1><div class="mt-15"><a href="/dark/home/home">Home</a><span class="padding-rl-20">|</span><span class="main-color">Works</span></div></div></div></header>`);
    };
  }
};
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/home-main/portfolio-metro/Header.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dark/home/works.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=works-COgMtGQ2.mjs.map
