...
import { unref, useSSRContext, mergeProps, onUnmounted, ref } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderAttr, ssrRenderClass } from 'vue/server-renderer';
import { _ as _sfc_main$4, a as _sfc_main$1$1, b as _sfc_main$2$1, L as Lines, c as _imports_0$1 } from './loader-jCTjqXsl.mjs';
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "min-footer2" }, _attrs))}><div class="footer-container"><div class="container pt-60 pb-25 ontop"><div class="text-center mb-30"><h6 class="sub-title mb-15">Get In Touch</h6><h2 class="fz-100 text-u ls1"><a href="/dark/page-contact2">Let&#39;s Talk</a></h2></div><div class="row mt-40 pt-25 bord-thin-top"><div class="col-lg-4 col-md-6 md-mb15"><div class="logo icon-img-100"><img${ssrRenderAttr("src", _imports_0$1)} alt=""></div></div><div class="col-lg-4 order-md-3"><div class="text-center"><p class="fz-14"> \xA9 2024 InFolio is Proudly Powered by <span class="underline main-color"><a href="https://themeforest.net/user/UiCamp" target="_blank"> UiCamp </a></span></p></div></div><div class="col-lg-4 col-md-6 order-md-2 md-mb15"><div class="links d-flex justify-content-end"><ul class="rest d-flex align-items-center"><li><a href="/dark/page-FAQS">FAQ</a></li><li class="ml-30"><a href="/dark/page-about3">Careers</a></li><li class="ml-30"><a href="/dark/page-contact3">Contact Us</a></li></ul></div></div></div></div></div></footer>`);
    };
  }
};
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/asymmetric-portfolio/Footer.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/asymmetric-portfolio/Navbar.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const _imports_0 = "" + publicAssetsURL("dark/assets/imgs/works/1/q1.jpg");
const _imports_1 = "" + publicAssetsURL("dark/assets/imgs/works/1/q2.jpg");
const _imports_2 = "" + publicAssetsURL("dark/assets/imgs/works/1/q3.jpg");
const _imports_3 = "" + publicAssetsURL("dark/assets/imgs/works/1/q4.jpg");
const _imports_4 = "" + publicAssetsURL("dark/assets/imgs/works/1/q5.jpg");
const _imports_5 = "" + publicAssetsURL("dark/assets/imgs/works/1/q6.jpg");
const _imports_6 = "" + publicAssetsURL("dark/assets/imgs/works/1/q7.jpg");
const _imports_7 = "" + publicAssetsURL("dark/assets/imgs/works/1/q8.jpg");
const _imports_8 = "" + publicAssetsURL("dark/assets/imgs/works/1/q9.jpg");
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "work-asymetic section-padding" }, _attrs))}><div class="container mt-100"><div class="caption"><div class="lg-text fw-300"><div class="text">Digital art</div><div class="text">director</div><div class="text">&amp; designer</div></div><p> We combine forward-thinking design with modern technology to tell stories that transform and grow our partners brands. </p></div><div class="row"><div class="col-lg-3 offset-lg-3 items"><div class="item"><div class="img"><img${ssrRenderAttr("src", _imports_0)} alt=""></div><div class="cont mt-30"><span class="opacity-7 text-u fz-13 ls1 mb-5"> August 2020 </span><h6><a href="/dark/project1">Branding Design</a></h6></div></div></div><div class="col-lg-6 items"><div class="item"><div class="img"><img${ssrRenderAttr("src", _imports_1)} alt=""></div><div class="cont d-flex align-items-center mt-30"><h6><a href="/dark/project2">Branding Design</a></h6><span class="opacity-7 text-u fz-13 ls1 ml-auto"> August 2020 </span></div></div></div><div class="col-lg-6 items"><div class="item"><div class="img"><img${ssrRenderAttr("src", _imports_2)} alt=""></div><div class="cont d-flex align-items-center mt-30"><h6><a href="/dark/project3">Branding Design</a></h6><span class="opacity-7 text-u fz-13 ls1 ml-auto"> August 2020 </span></div></div></div><div class="col-lg-3 offset-lg-2 items d-flex align-items-end"><div class="item full-width"><div class="img"><img${ssrRenderAttr("src", _imports_3)} alt=""></div><div class="cont mt-30"><span class="opacity-7 text-u fz-13 ls1 mb-5"> August 2020 </span><h6><a href="/dark/project4">Branding Design</a></h6></div></div></div><div class="col-lg-4 items"><div class="item"><div class="img"><img${ssrRenderAttr("src", _imports_4)} alt=""></div><div class="cont mt-30"><span class="opacity-7 text-u fz-13 ls1 mb-5"> August 2020 </span><h6><a href="/dark/project5">Branding Design</a></h6></div></div></div><div class="col-lg-6 offset-lg-2"><div class="row lg-marg"><div class="col-lg-6 items"><div class="item"><div class="img"><img${ssrRenderAttr("src", _imports_5)} alt=""></div><div class="cont mt-30"><span class="opacity-7 text-u fz-13 ls1 mb-5"> August 2020 </span><h6><a href="/dark/project6">Branding Design</a></h6></div></div></div><div class="col-lg-6 items"><div class="item"><div class="img"><img${ssrRenderAttr("src", _imports_6)} alt=""></div><div class="cont mt-30"><span class="opacity-7 text-u fz-13 ls1 mb-5"> August 2020 </span><h6><a href="/dark/project1">Branding Design</a></h6></div></div></div></div></div><div class="col-lg-4 items d-flex align-items-end"><div class="item full-width"><div class="img"><img${ssrRenderAttr("src", _imports_7)} alt=""></div><div class="cont d-flex align-items-center mt-30"><h6><a href="/dark/project2">Branding Design</a></h6><span class="opacity-7 text-u fz-13 ls1 ml-auto"> August 2020 </span></div></div></div><div class="col-lg-7 offset-lg-1 items"><div class="item"><div class="img"><img${ssrRenderAttr("src", _imports_8)} alt=""></div><div class="cont d-flex align-items-center mt-30"><h6><a href="/dark/project3">Branding Design</a></h6><span class="opacity-7 text-u fz-13 ls1 ml-auto"> August 2020 </span></div></div></div></div></div></section>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/asymmetric-portfolio/Portfolio.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dark/home-asymmetric-portfolio.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=home-asymmetric-portfolio-Cp2t0MhJ.mjs.map
