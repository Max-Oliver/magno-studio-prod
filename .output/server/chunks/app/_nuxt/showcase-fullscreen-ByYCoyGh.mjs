          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(SwiperSlide), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="bg-img valign" data-background="assets/imgs/works/full/1.jpg" data-overlay-dark="3"${_scopeId2}><div class="container"${_scopeId2}><div class="row"${_scopeId2}><div class="col-lg-11 offset-lg-1"${_scopeId2}><div class="caption"${_scopeId2}><h6 class="sub-title mb-30" data-swiper-parallax="-1000"${_scopeId2}> \xA9 2023 <br${_scopeId2}> Branding </h6><h1${_scopeId2}><a href="project1.html"${_scopeId2}><span data-swiper-parallax="-2000"${_scopeId2}>Retouch Photo</span></a></h1></div></div></div></div></div>`);
                } else {
                  return [
                    createVNode("div", {
                      class: "bg-img valign",
            ...
            _push2(ssrRenderComponent(unref(SwiperSlide), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="bg-img valign" data-background="assets/imgs/works/full/2.jpg" data-overlay-dark="3"${_scopeId2}><div class="container"${_scopeId2}><div class="row"${_scopeId2}><div class="col-lg-11 offset-lg-1"${_scopeId2}><div class="caption"${_scopeId2}><h6 class="sub-title mb-30" data-swiper-parallax="-1000"${_scopeId2}> \xA9 2023 <br${_scopeId2}> Branding </h6><h1${_scopeId2}><a href="project6.html"${_scopeId2}><span data-swiper-parallax="-2000"${_scopeId2}>Earthmade</span><br${_scopeId2}><span data-swiper-parallax="-3000"${_scopeId2}>Aroma box</span></a></h1></div></div></div></div></div>`);
                } else {
                  return [
                    createVNode("div", {
                      class: "bg-img valign",
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/light/showcase-fullscreen.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=showcase-fullscreen-ByYCoyGh.mjs.map
