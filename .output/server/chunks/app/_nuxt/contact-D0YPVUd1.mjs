...
import { useSSRContext, unref, defineComponent, computed, reactive, ref, mergeProps } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderStyle, ssrIncludeBooleanAttr } from 'vue/server-renderer';
import { _ as _sfc_main$2$1, a as _sfc_main$3$1, b as _sfc_main$4, L as Lines, N as Navbar, W as WhatsAppFloat, F as Footer, u as useWhatsapp } from './WhatsAppFloat-CTnZKLQ4.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (status.value) {
        ...
        if (status.value === "ok") {
          _push(`<p class="text-green-500">\xA1Mensaje enviado! Te responderemos a la brevedad. </p>`);
        } else {
...
//# sourceMappingURL=contact-D0YPVUd1.mjs.map
