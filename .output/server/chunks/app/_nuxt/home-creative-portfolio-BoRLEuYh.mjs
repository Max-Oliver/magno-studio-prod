...
import { unref, useSSRContext, onUnmounted, mergeProps, ref, withCtx, createVNode, openBlock, createBlock, toDisplayString, Fragment, renderList } from 'vue';
...
import { _ as _sfc_main$b, a as _sfc_main$1$1, b as _sfc_main$2$1, L as Lines, c as _imports_0$3 } from './loader-CCDLJnCr.mjs';
import { _ as _imports_0$1 } from './03-ChmKl91R.mjs';
import { _ as _imports_0$2, a as _imports_1, b as _imports_2$1, c as _imports_3$1, d as _imports_4$1 } from './05-Dd0T5s0G.mjs';
import { i as isInView } from './isInView-VXyFXDVH.mjs';
import { _ as _imports_0$4, a as _imports_1$1, b as _imports_2$2 } from './c3-DX5JR0pm.mjs';
...
_sfc_main$a.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/creative-portfolio/About.vue");
  return _sfc_setup$a ? _sfc_setup$a(props, ctx) : void 0;
};
const _sfc_main$9 = {};
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "blog-crev section-padding sub-bg radius-30 mt-15" }, _attrs))}><div class="container"><div class="sec-head text-center mb-80"><h6 class="sub-title main-color mb-15">Latest News</h6><h2>Look at the articles</h2><div class="fixed-head main-bg"><h5 class="stroke">Blog</h5><div class="shap-right-top"><svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11"><path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1a1a1a"></path></svg></div><div class="shap-left-bottom"><svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11"><path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1a1a1a"></path></svg></div></div></div><div class="row"><div class="col-lg-4"><div class="item sub-bg2 md-mb50"><div class="img"><img${ssrRenderAttr("src", _imports_0$4)} alt=""><div class="tag sub-bg2"><span>Envato</span><div class="shap-right-bottom"><svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11"><path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#222"></path></svg></div><div class="shap-left-bottom"><svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11"><path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#222"></path></svg></div></div></div><div class="cont"><div class="date sub-title mb-10 opacity-7"><a href="/light/blog-list">30 august 2021</a></div><h5><a href="/light/blog-list"> Creative advertising in our life became a info noise </a></h5></div></div></div><div class="col-lg-4"><div class="item sub-bg2 md-mb50"><div class="img"><img${ssrRenderAttr("src", _imports_1$1)} alt=""><div class="tag sub-bg2"><span>Envato</span><div class="shap-right-bottom"><svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11"><path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#222"></path></svg></div><div class="shap-left-bottom"><svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11"><path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#222"></path></svg></div></div></div><div class="cont"><div class="date sub-title mb-10 opacity-7"><a href="/light/blog-list">30 august 2021</a></div><h5><a href="/light/blog-list"> Creative advertising in our life became a info noise </a></h5></div></div></div><div class="col-lg-4"><div class="item sub-bg2"><div class="img"><img${ssrRenderAttr("src", _imports_2$2)} alt=""><div class="tag sub-bg2"><span>Envato</span><div class="shap-right-bottom"><svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11"><path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#222"></path></svg></div><div class="shap-left-bottom"><svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11"><path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#222"></path></svg></div></div></div><div class="cont"><div class="date sub-title mb-10 opacity-7"><a href="/light/blog-list">30 august 2021</a></div><h5><a href="/light/blog-list"> We create some things for your success in growth </a></h5></div></div></div></div></div></section>`);
}
const _sfc_setup$9 = _sfc_main$9.setup;
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/creative-portfolio/Blog.vue");
  return _sfc_setup$9 ? _sfc_setup$9(props, ctx) : void 0;
};
const Blog = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$3]]);
const _sfc_main$8 = {};
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "sub-bg radius-30 mt-15" }, _attrs))}><div class="container pb-40 pt-80 ontop"><div class="d-flex justify-content-center mb-30"><div class="logo icon-img-120"><img${ssrRenderAttr("src", _imports_0$3)} alt=""></div></div><div class="info-comp d-flex align-items-center justify-content-center pt-40 pb-40 bord-thin-bottom bord-thin-top"><div class="mr-30"><span class="icon main-color mr-10 ti-email"></span><span class="text">Support@Website.com</span></div><div class="mr-30"><span class="icon main-color mr-10 ti-mobile"></span><span class="text">+2 456 (343) 24 45</span></div><div><span class="icon main-color mr-10 ti-location-pin"></span><span class="text">Trussville 43 Crossings, Birmingham</span></div></div><div class="row sub-footer mt-40 pt-25 pb-25 main-bg radius-30 padding-rl-30"><div class="col-lg-4 col-md-6 md-mb15"><ul class="rest d-flex align-items-center"><li class="hover-this cursor-pointer"><a href="#0" class="hover-anim"><i class="fab fa-facebook-f"></i></a></li><li class="hover-this cursor-pointer ml-30"><a href="#0" class="hover-anim"><i class="fab fa-dribbble"></i></a></li><li class="hover-this cursor-pointer ml-30"><a href="#0" class="hover-anim"><i class="fab fa-linkedin-in"></i></a></li><li class="hover-this cursor-pointer ml-30"><a href="#0" class="hover-anim"><i class="fab fa-instagram"></i></a></li></ul></div><div class="col-lg-4 order-md-3"><div class="text-center"><p class="fz-14"> \xA9 2024 InFolio is Proudly Powered by <span class="underline main-color"><a href="https://themeforest.net/user/UiCamp" target="_blank"> UiCamp </a></span></p></div></div><div class="col-lg-4 col-md-6 md-mb15 order-md-2"><div class="links d-flex justify-content-end"><ul class="rest d-flex align-items-center"><li><a href="/light/page-FAQS">FAQ</a></li><li class="ml-30"><a href="/light/page-about2">Careers</a></li><li class="ml-30"><a href="/light/page-contact2">Contact Us</a></li></ul></div></div></div></div></footer>`);
}
const _sfc_setup$8 = _sfc_main$8.setup;
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/creative-portfolio/Footer.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/creative-portfolio/Header.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const _sfc_main$6 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "marquee-action section-padding sub-bg radius-30 mt-15 o-hidden" }, _attrs))}><div class="container-fluid"><div class="main-marq xlrg text-u"><div class="slide-har st1"><div class="box"><div class="item"><h4 class="d-flex align-items-center fw-800"><a href="/light/page-contact2">Get In Touch</a><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center fw-800"><a href="/light/page-contact2">Contact Us</a><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center fw-800"><a href="/light/page-contact2">Get In Touch</a><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center fw-800"><a href="/light/page-contact2">Contact Us</a><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center fw-800"><a href="/light/page-contact2">Get In Touch</a><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center fw-800"><a href="/light/page-contact2">Contact Us</a><span class="fz-50 ml-50 stroke icon">*</span></h4></div></div><div class="box"><div class="item"><h4 class="d-flex align-items-center fw-800"><a href="/light/page-contact2">Get In Touch</a><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center fw-800"><a href="/light/page-contact2">Contact Us</a><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center fw-800"><a href="/light/page-contact2">Get In Touch</a><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center fw-800"><a href="/light/page-contact2">Contact Us</a><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center fw-800"><a href="/light/page-contact2">Get In Touch</a><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center fw-800"><a href="/light/page-contact2">Contact Us</a><span class="fz-50 ml-50 stroke icon">*</span></h4></div></div></div></div></div></section>`);
}
const _sfc_setup$6 = _sfc_main$6.setup;
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/creative-portfolio/Marquee.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/creative-portfolio/Navbar.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const _imports_0 = "" + publicAssetsURL("light/assets/imgs/works/2/1.jpg");
const _imports_2 = "" + publicAssetsURL("light/assets/imgs/works/2/2.jpg");
const _imports_3 = "" + publicAssetsURL("light/assets/imgs/works/2/3.jpg");
const _imports_4 = "" + publicAssetsURL("light/assets/imgs/works/2/4.jpg");
const _imports_5 = "" + publicAssetsURL("light/assets/imgs/works/2/5.jpg");
const _sfc_main$4 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "portfolio-clean section-padding pt-0" }, _attrs))}><div class="container"><div class="row"><div class="col-lg-5"><div class="item mb-30"><div class="img"><img${ssrRenderAttr("src", _imports_0)} alt=""><div class="cont d-flex align-items-center"><div><h5>Nice guy with a smile</h5><p>Graphic Designing</p></div><div class="ml-auto"><a href="/light/project1" class="rmore"><img${ssrRenderAttr("src", _imports_1$2)} alt="" class="icon-img-20"></a></div></div></div></div></div><div class="col-lg-7"><div class="item mb-30"><div class="img"><img${ssrRenderAttr("src", _imports_2)} alt=""><div class="cont d-flex align-items-center"><div><h5>Nice guy with a smile</h5><p>Graphic Designing</p></div><div class="ml-auto"><a href="/light/project2" class="rmore"><img${ssrRenderAttr("src", _imports_1$2)} alt="" class="icon-img-20"></a></div></div></div></div></div><div class="col-lg-4"><div class="item md-mb30"><div class="img"><img${ssrRenderAttr("src", _imports_3)} alt=""><div class="cont d-flex align-items-center"><div><h5>Nice guy with a smile</h5><p>Graphic Designing</p></div><div class="ml-auto"><a href="/light/project3" class="rmore"><img${ssrRenderAttr("src", _imports_1$2)} alt="" class="icon-img-20"></a></div></div></div></div></div><div class="col-lg-4"><div class="item md-mb30"><div class="img"><img${ssrRenderAttr("src", _imports_4)} alt=""><div class="cont d-flex align-items-center"><div><h5>Nice guy with a smile</h5><p>Graphic Designing</p></div><div class="ml-auto"><a href="/light/project4" class="rmore"><img${ssrRenderAttr("src", _imports_1$2)} alt="" class="icon-img-20"></a></div></div></div></div></div><div class="col-lg-4"><div class="item"><div class="img"><img${ssrRenderAttr("src", _imports_5)} alt=""><div class="cont d-flex align-items-center"><div><h5>Nice guy with a smile</h5><p>Graphic Designing</p></div><div class="ml-auto"><a href="/light/project5" class="rmore"><img${ssrRenderAttr("src", _imports_1$2)} alt="" class="icon-img-20"></a></div></div></div></div></div></div></div></section>`);
}
const _sfc_setup$4 = _sfc_main$4.setup;
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/creative-portfolio/Portfolio.vue");
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "services-dots section-padding sub-bg radius-30 mt-15" }, _attrs))}><div class="container"><div class="sec-head text-center mb-80"><h6 class="sub-title main-color mb-15">Our Specialize</h6><h2>What We Have to Offer</h2><div class="fixed-head main-bg"><h5 class="stroke">Services</h5><div class="shap-right-top"><svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11"><path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1a1a1a"></path></svg></div><div class="shap-left-bottom"><svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11"><path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1a1a1a"></path></svg></div></div></div><div class="row xlg-marg ontop"><div class="col-lg-4"><div class="item md-mb50"><h4 class="bg-img mb-30" data-background="/light/assets/imgs/serv-img/1.jpg"> U </h4><h5>UI-UX Design</h5><div class="text mt-15"><p class="mb-30"> Help increase the traffic into your business via marketing online &amp; offline. </p><ul class="rest dot-list fz-18"><li class="mb-10">Website Design</li><li class="mb-10">UI/UX Design</li><li class="mb-10">Mobile App Development</li><li>Animations</li></ul></div></div></div><div class="col-lg-4"><div class="item md-mb50"><h4 class="bg-img mb-30" data-background="/light/assets/imgs/serv-img/2.jpg"> B </h4><h5>Brand Strategy</h5><div class="text mt-15"><p class="mb-30"> Help increase the traffic into your business via marketing online &amp; offline. </p><ul class="rest dot-list fz-18"><li class="mb-10">Website Design</li><li class="mb-10">UI/UX Design</li><li class="mb-10">Mobile App Development</li><li>Animations</li></ul></div></div></div><div class="col-lg-4"><div class="item"><h4 class="bg-img mb-30" data-background="/light/assets/imgs/serv-img/4.jpg"> S </h4><h5>SEO &amp; Marketing</h5><div class="text mt-15"><p class="mb-30"> Help increase the traffic into your business via marketing online &amp; offline. </p><ul class="rest dot-list fz-18"><li class="mb-10">Website Design</li><li class="mb-10">UI/UX Design</li><li class="mb-10">Mobile App Development</li><li>Animations</li></ul></div></div></div></div></div></section>`);
    };
  }
};
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/creative-portfolio/Services.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/creative-portfolio/Team.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/creative-portfolio/Testimonials.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/light/home-creative-portfolio.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=home-creative-portfolio-BoRLEuYh.mjs.map
