...
import { _ as _sfc_main$4 } from './Footer-BSPCG1_Q.mjs';
...
const _imports_0 = "" + publicAssetsURL("dark/assets/imgs/404.png");
const _sfc_main$1 = {};
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dark/page-error404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=page-error404-BkJbMlmi.mjs.map
