...
import { onUnmounted, mergeProps, useSSRContext, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList } from "vue";
...
import { _ as _sfc_main$c, a as _sfc_main$d, b as _sfc_main$e, L as Lines } from "./loader-CbuutFIZ.js";
import { _ as _sfc_main$f } from "./Navbar-DP9J-Bvz.js";
import { _ as _imports_0 } from "./03-DYXBsvJS.js";
import { i as isInView } from "./isInView-VXyFXDVH.js";
import { _ as _imports_0$1, a as _imports_2 } from "./3-B497koQy.js";
import { _ as _imports_1 } from "./author-CbTf732r.js";
import { _ as _imports_0$2, a as _imports_1$1, b as _imports_2$1, c as _imports_3, d as _imports_4 } from "./05-Ry52bwAK.js";
import { S as Swiper, a as SwiperSlide } from "./swiper-slide-Dn_WuJYw.js";
import "ssr-window";
import { _ as _sfc_main$g } from "./Footer-DLrBKTQx.js";
...
import { d as data$1 } from "./services-Gdc-2V7P.js";
import { _ as _imports_1$3, a as _imports_3$1, b as _imports_4$1 } from "./2-Ddu6grhE.js";
import { _ as _imports_2$2 } from "./02-D3NKgtkr.js";
import { d as data$2 } from "./team-D6p_iKBL.js";
import { d as data$3 } from "./testimonials-Dq-BK1h4.js";
import "../server.mjs";
...
_sfc_main$b.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-agency/About.vue");
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-agency/Blog.vue");
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(SwiperSlide), { class: "swiper-slide" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="item"${_scopeId2}><div class="img icon-img-100"${_scopeId2}><a href="#0"${_scopeId2}><img${ssrRenderAttr("src", _imports_1$1)} alt=""${_scopeId2}></a></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "item" }, [
                      createVNode("div", { class: "img icon-img-100" }, [
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-agency/Brands.vue");
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(SwiperSlide), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="bg-img valign" data-background="/dark/assets/imgs/header/full/1.jpg" data-overlay-dark="4"${_scopeId2}><div class="container"${_scopeId2}><div class="caption text-center"${_scopeId2}><h2 class="mb-30" data-swiper-parallax="-2000"${_scopeId2}>We Create</h2><h1${_scopeId2}><span data-swiper-parallax="-1000"${_scopeId2}>Awoseme Design</span></h1></div></div></div>`);
                } else {
                  return [
                    createVNode("div", {
                      class: "bg-img valign",
            ...
            _push2(ssrRenderComponent(unref(SwiperSlide), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="bg-img valign" data-background="/dark/assets/imgs/header/full/3.jpg" data-overlay-dark="4"${_scopeId2}><div class="container"${_scopeId2}><div class="caption text-center"${_scopeId2}><h2 class="mb-30" data-swiper-parallax="-2000"${_scopeId2}> We Create Impactful </h2><h1${_scopeId2}><span data-swiper-parallax="-1000"${_scopeId2}>Digital Experiences</span></h1></div></div></div>`);
                } else {
                  return [
                    createVNode("div", {
                      class: "bg-img valign",
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-agency/Header.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-agency/Marquee.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-agency/Number.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-agency/Portfolio.vue");
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(data$1), (item, i) => {
        _push(`<div class="col-md-6"><div class="item-box2 mb-30"><div class="icon mb-40"><img${ssrRenderAttr("src", item.img)} alt=""></div><h5 class="mb-15">${ssrInterpolate(item.title)}</h5><p>${ssrInterpolate(item.desc)}</p><a${ssrRenderAttr("href", item.link)} class="rmore"><div class="arrow"><img${ssrRenderAttr("src", _imports_1$2)} alt="" class="icon-img-20"></div><div class="shap-left-top"><svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11"><path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1a1a1a"></path></svg></div><div class="shap-right-bottom"><svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11"><path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1a1a1a"></path></svg></div></a></div></div>`);
      });
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-agency/Services.vue");
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-agency/ServicesTab.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-agency/Team.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-agency/Testimonials.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/dark/home-modern-agency.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=home-modern-agency-Bj1XsN24.js.map
