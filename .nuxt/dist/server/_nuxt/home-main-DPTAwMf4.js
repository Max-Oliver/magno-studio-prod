...
import { mergeProps, useSSRContext, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString } from "vue";
...
import { _ as _imports_0$3, a as _sfc_main$c, b as _sfc_main$d, c as _sfc_main$e, L as Lines } from "./loader-CCDLJnCr.js";
import { _ as _imports_0$2, a as _imports_2 } from "./3-hVDirBa9.js";
...
import { _ as _imports_0$4 } from "./1-BDb2Kgk4.js";
import { _ as _imports_1$1, a as _imports_2$1 } from "./3-BSUExDzr.js";
...
const _imports_0$1 = "" + __publicAssetsURL("light/assets/imgs/header/2.jpg");
const _sfc_main$8 = {
  __name: "Header",
  __ssrInlineRender: true,
  setup(__props) {
...
const _imports_0 = "" + __publicAssetsURL("light/assets/imgs/intro/04.jpg");
const _sfc_main$4 = {};
          ...
          if (_push2) {
            ...
            ssrRenderList(unref(data$1).slice(0, 4), (item, i) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), { key: i }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="item-box radius-15"${_scopeId2}><div class="icon mb-40 opacity-5"${_scopeId2}><img${ssrRenderAttr("src", item.img)} alt=""${_scopeId2}></div><h5 class="mb-15"${_scopeId2}>${ssrInterpolate(item.title)}</h5><p${_scopeId2}>${ssrInterpolate(item.desc)}</p><a${ssrRenderAttr("href", item.link)} class="rmore mt-30"${_scopeId2}><span class="sub-title"${_scopeId2}>Read More</span><img${ssrRenderAttr("src", _imports_1$2)} alt="" class="icon-img-20 ml-5"${_scopeId2}></a></div>`);
                  } else {
                    return [
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/light/home-main.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=home-main-DPTAwMf4.js.map
