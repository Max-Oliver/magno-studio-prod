...
import { _ as _sfc_main$e } from "./Footer-Bm73Q4r7.js";
import { a as _sfc_main$8, b as _sfc_main$9, c as _sfc_main$a, L as Lines } from "./loader-CCDLJnCr.js";
import { _ as _sfc_main$b } from "./Navbar-DzEBLQao.js";
import { _ as _imports_0 } from "./4-C11y4wKf.js";
import { _ as _sfc_main$c, a as _sfc_main$d, B as Blog } from "./Blog-Ce9VAjab.js";
import { _ as _imports_0$1 } from "./2-DrRViv9P.js";
import { _ as _imports_0$2, a as _imports_1, b as _imports_2, c as _imports_3, d as _imports_4 } from "./05-Dd0T5s0G.js";
import { S as Swiper, a as SwiperSlide } from "./swiper-slide-Dn_WuJYw.js";
import { _ as _imports_0$3 } from "./03-ChmKl91R.js";
import { _ as _imports_1$1, a as _imports_3$1, b as _imports_4$1 } from "./2-enjK3PBR.js";
...
import "dom7";
import "./team-CnJGwuLU.js";
import "./3-hVDirBa9.js";
import "./author-DIkYSGQ7.js";
const _sfc_main$7 = {};
...
_sfc_main$7.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/about2/Header.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/about2/Intro.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/about2/Marquee.vue");
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(SwiperSlide), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="item"${_scopeId2}><div class="img icon-img-100"${_scopeId2}><a href="#0"${_scopeId2}><img${ssrRenderAttr("src", _imports_0$2)} alt=""${_scopeId2}></a></div></div>`);
                } else {
                  return [
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/about2/Brands.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/about2/Services.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/light/page-about2.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=page-about2-Dyxb23yL.js.map
