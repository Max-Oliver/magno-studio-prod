...
import { mergeProps, unref, useSSRContext, ref, onUnmounted, withCtx, createVNode, openBlock, createBlock, toDisplayString, Fragment, renderList } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderClass, ssrRenderComponent, ssrRenderStyle } from "vue/server-renderer";
import { _ as _imports_0$1, a as _sfc_main$e, b as _sfc_main$f, c as _sfc_main$g, L as Lines } from "./loader-jCTjqXsl.js";
import { d as data } from "./services-Gdc-2V7P.js";
import { _ as _imports_0$2 } from "./2-_rZ-GbIF.js";
import { _ as _imports_0$3 } from "./1-B1Q864LO.js";
import { _ as _imports_1$2, a as _imports_2$2 } from "./3-Bn4yLYcT.js";
import { _ as _imports_3$2, a as _imports_4$1 } from "./5-Dh0eIOr1.js";
import { _ as _imports_0$4 } from "./2-U3Hs8MEd.js";
import { _ as _imports_0$5 } from "./03-DYXBsvJS.js";
...
import { _ as _imports_0$6, a as _imports_2$3 } from "./3-B497koQy.js";
import { _ as _imports_1$3 } from "./author-CbTf732r.js";
import "../server.mjs";
...
_sfc_main$d.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-startup/Services.vue");
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({
        ...
        "data-scroll-index": "0"
      }, _attrs))}><div class="valign bg-img" data-background="/dark/assets/imgs/background/1.jpg" data-overlay-dark="5"><div class="container pt-40"><div class="caption"><div class="lg-text fw-600"><div class="text d-flex align-items-center"><span>We create</span></div><div class="text">impactful</div><div class="text">digital experiences</div></div><p> We combine forward-thinking design with modern technology to tell stories that transform and grow our partners brands. </p></div></div></div></header>`);
    };
  }
};
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-startup/Header.vue");
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-startup/Navbar.vue");
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-startup/Marquee.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-startup/Portfolio.vue");
  return _sfc_setup$8 ? _sfc_setup$8(props, ctx) : void 0;
};
const _sfc_main$7 = {};
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "in-box mb-15" }, _attrs))}><div class="img-scale"><div class="image" data-overlay-dark="4"><div class="img"><img id="grow"${ssrRenderAttr("src", _imports_0$4)} data-speed="0.2" data-lag="0" alt=""><a href="https://youtu.be/AzwC6umvd1s" class="vid vid-circle d-flex align-items-center justify-content-center"><span class="icon fz-50 ti-control-play"></span></a></div></div></div></div>`);
}
const _sfc_setup$7 = _sfc_main$7.setup;
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-startup/ImageScale.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const ImageScale = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$3]]);
const _imports_1$1 = "" + __publicAssetsURL("dark/assets/imgs/team/1.jpg");
const _imports_2$1 = "" + __publicAssetsURL("dark/assets/imgs/team/2.jpg");
const _imports_3$1 = "" + __publicAssetsURL("dark/assets/imgs/team/3.jpg");
const _sfc_main$6 = {
  __name: "Skills",
  __ssrInlineRender: true,
  setup(__props) {
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-startup/Skills.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-startup/Testimonials.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const _imports_0 = "" + __publicAssetsURL("dark/assets/imgs/brands/b1.png");
const _imports_1 = "" + __publicAssetsURL("dark/assets/imgs/brands/b2.png");
const _imports_2 = "" + __publicAssetsURL("dark/assets/imgs/brands/b3.png");
const _imports_3 = "" + __publicAssetsURL("dark/assets/imgs/brands/b4.png");
const _imports_4 = "" + __publicAssetsURL("dark/assets/imgs/brands/b6.png");
const _sfc_main$4 = {
  __name: "Clients",
  __ssrInlineRender: true,
  setup(__props) {
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-startup/Clients.vue");
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/modern-startup/Blog.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dark/home-startup-onepage.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=home-startup-onepage-DYiAroQg.js.map
