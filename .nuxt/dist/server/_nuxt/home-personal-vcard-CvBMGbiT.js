...
import { onUnmounted, ref, useSSRContext, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, toDisplayString, Fragment, renderList } from "vue";
import { ssrRenderAttr, ssrRenderClass, ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderComponent } from "vue/server-renderer";
import { _ as _imports_0, a as _sfc_main$b, b as _sfc_main$c, c as _sfc_main$d, L as Lines } from "./loader-CCDLJnCr.js";
import { _ as _imports_0$1, a as _imports_1, b as _imports_2$1, c as _imports_3 } from "./s4-DXuPQI_V.js";
...
_sfc_main$a.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/personal-vcard/Navbar.vue");
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/personal-vcard/Intro.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/personal-vcard/Skills.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/personal-vcard/Resume.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/personal-vcard/Services.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const _imports_2 = "" + __publicAssetsURL("light/assets/imgs/works/1/h2.png");
const _sfc_main$5 = {};
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: "work-minimal section-padding bord-thin-top",
    "data-scroll-index": "4"
  }, _attrs))}><div class="sec-head mb-50"><h3>My <span class="fw-200">Portfolio</span></h3></div><div class="gallery row sm-marg"><div class="items col-md-6"><div class="item mb-10"><div class="img"><img${ssrRenderAttr("src", _imports_1$2)} alt=""><div class="cont"><h5><a href="/light/project1">Nice guy with a smile</a></h5><p><a href="/light/portfolio-gallery">Graphic Design</a></p></div></div></div></div><div class="items col-md-6"><div class="item mb-10"><div class="img"><img${ssrRenderAttr("src", _imports_2$2)} alt=""><div class="cont"><h5><a href="/light/project1">Nice guy with a smile</a></h5><p><a href="/light/portfolio-gallery">Graphic Design</a></p></div></div></div></div><div class="items col-12"><div class="item"><div class="img"><img${ssrRenderAttr("src", _imports_2)} alt=""><div class="cont d-flex align-items-center"><div><h5><a href="/light/project1">Nice guy with a smile</a></h5></div><div class="ml-auto"><p><a href="/light/portfolio-gallery">Graphic Design</a></p></div></div></div></div></div></div></section>`);
}
const _sfc_setup$5 = _sfc_main$5.setup;
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/personal-vcard/Portfolio.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/personal-vcard/Testimonials.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/personal-vcard/VcardPage.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/light/home-personal-vcard.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=home-personal-vcard-CvBMGbiT.js.map
