...
import { mergeProps, useSSRContext, unref, withCtx, createVNode, openBlock, createBlock, toDisplayString, Fragment, renderList } from "vue";
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrRenderList, ssrInterpolate } from "vue/server-renderer";
import { _ as _imports_0, a as _sfc_main$4, b as _sfc_main$5, c as _sfc_main$6, L as Lines } from "./loader-CCDLJnCr.js";
...
import { _ as _imports_0$1, a as _imports_1, b as _imports_2, c as _imports_3, d as _imports_4, e as _imports_5, f as _imports_6, g as _imports_7 } from "./h4-BIfHyAMt.js";
import "../server.mjs";
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/minimal-portfolio/Footer.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/minimal-portfolio/Testimonials.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "work-minimal section-padding pb-0" }, _attrs))}><div class="container mt-100"><div class="row"><div class="col-12"><div class="sec-head mb-80"><div class="text"><h1 class="fz-80"> Crafting digital products, <span class="opacity-7 d-block">brands &amp; experience</span></h1></div></div></div></div><div class="gallery2 row stand-marg"><div class="col-lg-6 items"><div class="item mt-40"><div class="img"><img${ssrRenderAttr("src", _imports_0$1)} alt=""><div class="cont d-flex align-items-center"><div><h5><a href="/light/project1">Nice guy with a smile</a></h5></div><div class="ml-auto"><p><a href="/light/portfolio-metro">Graphic Designing</a></p></div></div></div></div></div><div class="col-lg-3 items width2"><div class="item mt-40"><div class="img"><img${ssrRenderAttr("src", _imports_1)} alt=""><div class="cont"><h5><a href="/light/project2">A Nice guy</a></h5><p><a href="/light/portfolio-metro">Graphic Design</a></p></div></div></div></div><div class="col-lg-3 items width2"><div class="item mt-40"><div class="img"><img${ssrRenderAttr("src", _imports_2)} alt=""><div class="cont"><h5><a href="/light/project3">A Nice guy</a></h5><p><a href="/light/portfolio-metro">Graphic Design</a></p></div></div></div></div><div class="col-lg-3 items width2"><div class="item mt-40"><div class="img"><img${ssrRenderAttr("src", _imports_3)} alt=""><div class="cont"><h5><a href="/light/project4">A Nice guy</a></h5><p><a href="/light/portfolio-metro">Graphic Design</a></p></div></div></div></div><div class="col-lg-3 items width2"><div class="item mt-40"><div class="img"><img${ssrRenderAttr("src", _imports_4)} alt=""><div class="cont"><h5><a href="/light/project6">A Nice guy</a></h5><p><a href="/light/portfolio-metro">Graphic Design</a></p></div></div></div></div><div class="col-lg-6 items"><div class="item mt-40"><div class="img"><img${ssrRenderAttr("src", _imports_5)} alt=""><div class="cont d-flex align-items-center"><div><h5><a href="/light/project3">Nice guy with a smile</a></h5></div><div class="ml-auto"><p><a href="/light/portfolio-metro">Graphic Designing</a></p></div></div></div></div></div><div class="col-lg-6 items"><div class="item mt-40"><div class="img"><img${ssrRenderAttr("src", _imports_6)} alt=""><div class="cont d-flex align-items-center"><div><h5><a href="/light/project4">Nice guy with a smile</a></h5></div><div class="ml-auto"><p><a href="/light/portfolio-metro">Graphic Designing</a></p></div></div></div></div></div><div class="col-lg-6 items"><div class="item mt-40"><div class="img"><img${ssrRenderAttr("src", _imports_7)} alt=""><div class="cont d-flex align-items-center"><div><h5><a href="/light/project5">Nice guy with a smile</a></h5></div><div class="ml-auto"><p><a href="/light/portfolio-metro">Graphic Designing</a></p></div></div></div></div></div></div></div></section>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/light/minimal-portfolio/portfolio.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/light/home-minimal-portfolio.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=home-minimal-portfolio-D1kSlJpB.js.map
