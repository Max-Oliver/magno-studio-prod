...
import { mergeProps, useSSRContext, onUnmounted, unref, withCtx, createVNode, openBlock, createBlock, toDisplayString, Fragment, renderList } from "vue";
...
import { _ as _sfc_main$c } from "./Footer-DF7rRJit.js";
import { _ as _sfc_main$8, a as _sfc_main$9, b as _sfc_main$a, L as Lines } from "./loader-CbuutFIZ.js";
import { _ as _sfc_main$b } from "./Navbar-DP9J-Bvz.js";
import { _ as _imports_0 } from "./4-CUa9Y2jh.js";
import { _ as _imports_0$1 } from "./01-D8KHWtxs.js";
import { _ as _imports_0$2 } from "./2-_rZ-GbIF.js";
import { _ as _imports_2 } from "./02-D3NKgtkr.js";
import { _ as _imports_0$3 } from "./03-DYXBsvJS.js";
import { i as isInView } from "./isInView-VXyFXDVH.js";
import { d as data } from "./testimonials-Dq-BK1h4.js";
import { S as Swiper, a as SwiperSlide } from "./swiper-slide-Dn_WuJYw.js";
import "ssr-window";
import { N as Navigation } from "./navigation-nPzHIgEI.js";
import { _ as _imports_0$4, a as _imports_1, b as _imports_2$1, c as _imports_3, d as _imports_4 } from "./05-Ry52bwAK.js";
import { _ as _imports_0$5, a as _imports_2$2 } from "./3-B497koQy.js";
import { _ as _imports_1$1 } from "./author-CbTf732r.js";
import "../server.mjs";
...
_sfc_main$7.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/about3/Header.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$2]]);
const _sfc_main$6 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "page-intro position-re" }, _attrs))}><div class="container-fluid rest"><div class="img fit-img"><img${ssrRenderAttr("src", _imports_0)} alt=""></div></div><div class="container section-padding"><div class="row"><div class="col-lg-5"><h6 class="sub-title main-color">About Company</h6></div><div class="col-lg-7"><div class="text"><h4> Whether you are a development agency looking to outsource design work, a company in search of a Product Designer or Product Team, a marketing agency that needs a landing page, a startup that wants to launch an app, or an enterprise that plans to rebrand or redesign its website, we welcome any challenge with our arms wide open. </h4></div></div></div></div><div class="line-overlay"><svg viewBox="0 0 1728 1101" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M-43 773.821C160.86 662.526 451.312 637.01 610.111 733.104C768.91 829.197 932.595 1062.9 602.782 1098.75C272.969 1134.6 676.888 25.4306 1852 1" style="${ssrRenderStyle({ "stroke-dasharray": "3246.53, 0" })}"></path></svg></div></section>`);
}
const _sfc_setup$6 = _sfc_main$6.setup;
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/about3/Intro.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/about3/Intro2.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/about3/Testimonials.vue");
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "team-tab bord-thin-bottom bord-thin-top" }, _attrs))}><div class="container-fluid rest"><div class="sec-head pb-30 pt-20 bord-thin-bottom"><div class="main-marq xlrg o-hidden"><div class="slide-har st1"><div class="box"><div class="item"><h4 class="d-flex align-items-center"><span>Meet Our Team</span><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center"><span>Meet Our Team</span><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center"><span>Meet Our Team</span><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center"><span>Meet Our Team</span><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center"><span>Meet Our Team</span><span class="fz-50 ml-50 stroke icon">*</span></h4></div></div><div class="box"><div class="item"><h4 class="d-flex align-items-center"><span>Meet Our Team</span><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center"><span>Meet Our Team</span><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center"><span>Meet Our Team</span><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center"><span>Meet Our Team</span><span class="fz-50 ml-50 stroke icon">*</span></h4></div><div class="item"><h4 class="d-flex align-items-center"><span>Meet Our Team</span><span class="fz-50 ml-50 stroke icon">*</span></h4></div></div></div></div></div><div class="row"><div class="col-lg-5 rest"><div class="glry-img"><div id="tab-1" class="bg-img tab-img current" data-background="/dark/assets/imgs/team/1.jpg"></div><div id="tab-2" class="bg-img tab-img" data-background="/dark/assets/imgs/team/2.jpg"></div><div id="tab-3" class="bg-img tab-img" data-background="/dark/assets/imgs/team/3.jpg"></div><div id="tab-4" class="bg-img tab-img" data-background="/dark/assets/imgs/team/4.jpg"></div><div id="tab-5" class="bg-img tab-img" data-background="/dark/assets/imgs/team/3.jpg"></div></div></div><div class="col-lg-7 rest content"><div class="cluom current" data-tab="tab-1"><div class="info"><h6 class="sub-title opacity-7">Web Designer</h6><h4>Robert De Niro</h4></div><div class="more text-u ls1 fz-12"><a href="/dark/page-team-single"> View More <i class="ml-15 ti-arrow-top-right"></i></a></div></div><div class="cluom" data-tab="tab-2"><div class="info"><h6 class="sub-title opacity-7">Project Manager</h6><h4>Brendan Fraser</h4></div><div class="more text-u ls1 fz-12"><a href="/dark/page-team-single"> View More <i class="ml-15 ti-arrow-top-right"></i></a></div></div><div class="cluom" data-tab="tab-3"><div class="info"><h6 class="sub-title opacity-7">Web Developer</h6><h4>Brendan Fraser</h4></div><div class="more text-u ls1 fz-12"><a href="/dark/page-team-single"> View More <i class="ml-15 ti-arrow-top-right"></i></a></div></div><div class="cluom" data-tab="tab-4"><div class="info"><h6 class="sub-title opacity-7">UI-UX Designer</h6><h4>Brendan Fraser</h4></div><div class="more text-u ls1 fz-12"><a href="/dark/page-team-single"> View More <i class="ml-15 ti-arrow-top-right"></i></a></div></div><div class="cluom" data-tab="tab-5"><div class="info"><h6 class="sub-title opacity-7">SEO Manager</h6><h4>Brendan Fraser</h4></div><div class="more text-u ls1 fz-12"><a href="/dark/page-team-single"> View More <i class="ml-15 ti-arrow-top-right"></i></a></div></div></div></div></div></section>`);
    };
  }
};
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/about3/Team.vue");
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(SwiperSlide), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="item"${_scopeId2}><div class="img icon-img-100"${_scopeId2}><a href="#0"${_scopeId2}><img${ssrRenderAttr("src", _imports_0$4)} alt=""${_scopeId2}></a></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "item" }, [
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/about3/Brands.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/dark/about3/Blog.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/old/dark/page-about3.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=page-about3-tBGa42-z.js.map
