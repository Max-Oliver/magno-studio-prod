...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/contact-D0YPVUd1.js").then((m) => m.default || m)
  },
  {
    name: "home-works",
    path: "/home/works",
    ...
    component: () => import("./_nuxt/works-CqV1hDJd.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-BRVSCgtJ.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DPGcHSjA.js").then((r) => r.default || r));
